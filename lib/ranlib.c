...
*/
{
  ...
  float k1;
  float k2;
  static float log4 = 1.3862943611198906188;
  static float log5 = 1.6094379124341003746;
  float r;
  float s;
  float t;
  float u1;
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "GENCHI - Fatal error!\n" );
    printf ( "  DF <= 0.\n" );
    printf ( "  Value of DF: %g\n", df );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "IGNBIN - Fatal error!\n" );
    printf ( "  PP is out of range.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  float difmuk;
  float e;
  float fact[10] = { 1.0, 1.0, 2.0, 6.0, 24.0, 
...
*/
{
  ...
  if ( maxnum < width )
  {
    printf ( "\n" );
    printf ( "IGNUIN - Fatal error!\n" );
    printf ( "  Range HIGH-LOW is too large.\n" );
    exit ( 1 );
  }
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "SETGMN - Fatal error!\n" );
    printf ( "  P was not positive.\n" );
    exit ( 1 );
  }
/*
  Store P.
...
*/
  ...
  if ( info != 0 )
  {
    printf ( "\n" );
    printf ( "SETGMN - Fatal error!\n" );
    printf ( "  SPOFA finds COVM not positive definite.\n" );
    exit ( 1 );
  }
/*
...
*/
{
  ...
  {
    printf ( "\n" );
    printf ( "TRSTAT - Fatal error!\n" );
    printf ( "  Illegal input value for PDF.\n" );
    exit ( 1 );
  }
  return;
}
